            ...
            <div>
                {!publicKey ? (
                    ...
                    <Dropdown>
                        ...
                        <DropdownMenu className="w-[300px] bg-black hover:bg-black">
                            <DropdownItem
                                key="1"
            ...
            <div className="flex flex-col justify-start items-center space-y-5  w-[300px] md:w-[400px] overflow-y-auto ">
                {wallets.map((wallet) => (
                    <Button
                        ...
                        onPress={() => handleWalletSelect(wallet.adapter.name)}
                        className="h-[40px] flex w-full text-[20px] text-white font-slackey"
                    >
                        <div className="flex">
                            <Image
